...
from telegram.utils.Plugins import escape_markdown

from DAXXMUSIC import dispatcher
from DAXXMUSIC.modules.Plugins.handlers import CMD_STARTERS, SpamChecker
from DAXXMUSIC.modules.Plugins.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from DAXXMUSIC.modules.helper_funcs.chat_status import (
        connection_status,
        is_user_admin,
        user_admin,
    )
    from DAXXMUSIC.modules.sql import disable_sql as sql
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "DAXXMUSIC.modules." + args[0].rsplit(".", 1)[0]
